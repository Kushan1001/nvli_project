...
if 'nvli-index-ebooks' not in all_indicies_list:
    ...
    loader = PyMuPDFLoader('/home/kushan/pml/02.Indian seals Problem and Prospects (2) (1).pdf')
    pdf = loader.load()
    ...
    loader = PyMuPDFLoader('/home/kushan/pml/06.An Introduction to the National Archives (1).pdf')
    pdf = loader.load()
    documents = text_splitter.split_documents(pdf)
    ...
    loader = PyMuPDFLoader('/home/kushan/pml/05.Archives and Records what are they (1).pdf')
    pdf = loader.load()
    documents = text_splitter.split_documents(pdf)

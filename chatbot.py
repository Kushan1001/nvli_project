...
# Frontend logic inside the main function
def main():
    if uploaded_files:
        ...
        def handle_query(user_input, word_limit):
            query = f"""You are an Indian Culture Portal chatbot. You are designed to be as helpful as possible while providing only factual information. 
                        Context information is below. Given the context information and not prior knowledge, answer the query.

                        When the user enters search for pdfs/ebooks/provide information/data you should search the entire ebook index thoroughly (do not miss details) and return the relevant information
                        along with the title of the book (that is written in the front of the book) and the page number. 

                        Do not give any conclusions.
                        
                        The name of the book and page number should be written at the end.

                        Answers should be given in {word_limit} words.
                        {user_input}
                    """
        ...
        def summarise_query(user_input, word_limit):
            summarise_query = f"""You are an Indian Culture Portal chatbot. You are designed to be as helpful as possible while providing only factual information. 
                        Context information is below. Given the context information and not prior knowledge, answer the query.
        ...
        st.markdown('Please upload PDF files to proceed.')
